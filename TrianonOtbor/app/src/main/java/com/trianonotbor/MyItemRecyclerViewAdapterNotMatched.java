 ...
 */
public class MyItemRecyclerViewAdapterNotMatched extends RecyclerView.Adapter<MyItemRecyclerViewAdapterNotMatched.ViewHolder> {
    ...
    private final FragmentNotMatched.OnFragmentInteractionListener mListener;

    public MyItemRecyclerViewAdapterNotMatched(List<ItemStrikeout> items, FragmentNotMatched.OnFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
