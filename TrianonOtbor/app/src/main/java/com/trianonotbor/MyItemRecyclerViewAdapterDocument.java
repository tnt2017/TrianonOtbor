 ...
 */
public class MyItemRecyclerViewAdapterDocument extends RecyclerView.Adapter<MyItemRecyclerViewAdapterDocument.ViewHolder> {
    ...
    private final FragmentDocument.OnFragmentInteractionListener mListener;

    public MyItemRecyclerViewAdapterDocument(List<ItemDocument> items, FragmentDocument.OnFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
