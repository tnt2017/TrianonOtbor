 ...
 */
public class MyItemRecyclerViewAdapterComplektovka2 extends RecyclerView.Adapter<MyItemRecyclerViewAdapterComplektovka2.ViewHolder> {
    ...
    private final FragmentComplektovka2.OnFragmentInteractionListener mListener;

    public MyItemRecyclerViewAdapterComplektovka2(List<ItemComplektovka> items, FragmentComplektovka2.OnFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
